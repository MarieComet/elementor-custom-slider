<?php
namespace ElementorCustomSlider\Widgets;
 ...
 * @since 1.0.0
 */
class Custom_Slider extends Widget_Base {
	...
	public function get_title() {
		return __( 'Custom Slider', 'elementor-custom-slider' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'custom',
			[
				'label' => __( 'Custom control', 'elementor-pro' ),
